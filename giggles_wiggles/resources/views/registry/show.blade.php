...
<section class="py-3">
    ...
    <div class="registry-card shadow p-4 mb-5 bg-white rounded d-none d-md-block">
        ...
        <div id="registry-card-info" class="row">
            ...
            <div id="registry-show-info"  class="col-md-6 mt-4">
                ...
                <p><strong>{{ (new DateTime($registry->eventDate))->format('M d, Y') }} </strong></p>
            ...
            <div class="col-md-6 barcode">
                <img src="/images/giggleswiggles.png" width="100" height="100" alt="Barcode Image" class="img-fluid float-right">
            </div>
        </div>
    </div>
