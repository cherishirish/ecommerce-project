    ...
    <div id="payment_container">
                ...
                <!-- User Details -->
                    ...
                    <div id="billing_details">
                        ...
                        <div id="user_info">
                            <div>
                                <h4 class="checkout_titles">Name:</h4> <p class="checkout_info">{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}</p>
                            </div>
                            <div>
                    ...
                    <input type="checkbox" id="shipping_address_different" checked value=1 class="form-check-input" name="shipping_address_different">
