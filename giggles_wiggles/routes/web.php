...
Route::get('/delete_shipping_address', [PageController::class, 'deleteShippingAddress'])->name('page.delete_shipping_address');
Route::get('/delete_billing_address', [PageController::class, 'deleteBillingAddress'])->name('page.delete_billing_address');
